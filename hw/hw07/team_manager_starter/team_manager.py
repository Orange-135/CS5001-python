...
def do_cut_player(team, bench):
    cut_name = input("Who do you want to cut?\n")
    cut_player_name = team.find_player(cut_name)

    if cut_player_name:
        team.cut_player(cut_player_name)
        bench.cut_player(cut_player_name)
    else:
        print(cut_player_name, "isn't on the team.")
